...
public class StoreClintBDataToCouhbase extends Thread {
	...
	public StoreClintBDataToCouhbase(String contactId, String email, String ip,String leadId) {
	...
	public StoreClintBDataToCouhbase(String contactId, String email, String ip,String leadId,String referralid) {
		this.contactId = contactId;
		this.email = email;
		this.ip = ip;
		this.leadId = leadId;
				...
				while (test) {
					...
					if (ip.equalsIgnoreCase(jsonObject.get("ip").toString())) {
						...
						couchBaseOperation.storeDataInCouchBase(
								"Vedio_clientBpage_" + key, jsonObject);
						test = false;
					} else {
						...
						try {
							...
							logger.error("Error occured while storingclientData to couchbase"+e.getMessage());
						}
					}
					}
				}
	...
	public JSONArray storeRealtorData(String contactId, String email) {
		...
		try {
			...
			String ur = "https://api.wistia.com/v1/stats/events.json?api_password=6bca8b64faaf09189e8266ed51b726292fd133063ffc1ca0d9fab9fc3661f3ab&start_date="
					...
					+ "&end_date="
					+ date.format(cal.getTime()) + "media_id=v6e3vd54bk";
			...
			logger.error("Error occured in storeRealtorData"+e.getMessage());
	...
	public JSONArray getVisitorCount() {
		...
		try {
			...
			// String
			// ur="https://api.wistia.com/v1/stats/events.json?api_password=6bca8b64faaf09189e8266ed51b726292fd133063ffc1ca0d9fab9fc3661f3ab";
			String ur = "https://api.wistia.com/v1/stats/visitors.json?api_password=6bca8b64faaf09189e8266ed51b726292fd133063ffc1ca0d9fab9fc3661f3ab&media_id=v6e3vd54bk";
			...
			logger.error("Error appears in connection"+e.getMessage());
