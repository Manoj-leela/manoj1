...
public class StorePlanerCDataToCouhbase extends Thread {
	...
	String leadId;
	String referralid;
	public StorePlanerCDataToCouhbase(String contactId, String email, String ip,String leadId) {
	...
	public StorePlanerCDataToCouhbase(String contactId, String email, String ip,String leadId,String referralid) {
	...
	public JSONArray storeRealtorData(String contactId, String email) {
		...
		try {
			...
			String ur = "https://api.wistia.com/v1/stats/events.json?api_password=6bca8b64faaf09189e8266ed51b726292fd133063ffc1ca0d9fab9fc3661f3ab&start_date="
					...
					+ "&end_date="
					+ date.format(cal.getTime()) + "media_id=hdwakgzahi";
			...
			logger.error("Error occured in JSONarray"+e.getMessage());
