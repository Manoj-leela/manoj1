...
public class StoreClientABCDataToCouchbase extends Thread {
	...
	String leadId;
	String referralid;
	public StoreClientABCDataToCouchbase(String contactId, String email, String ip,String leadId) {
	...
	public StoreClientABCDataToCouchbase(String contactId, String email, String ip,String leadId,String referralid) {
	...
	public void run() {
		...
		try {
			Thread.sleep(240000);
			 ...
			 logger.error("Error occured while running json object"+e.getMessage());
		}
		...
		email_from=nameEmailList.get(1);
			 ...
			 logger.error("Error occured in JSONobject"+e.getMessage());
		}
		if (jsonArray != null) {
			...
			try {
				while (test) {
					...
					if (ip.equalsIgnoreCase(jsonObject.get("ip").toString())) {
						...
						couchBaseOperation.storeDataInCouchBase(
								"Vedio_clientABpage_" + key, jsonObject);
						test = false;
					} else {
						...
						try {
							Thread.sleep(200000);
							 ...
							 logger.error("Error occured while storing data in couchbase"+e.getMessage());
						}
					}
					}
				}
				...
				// TODO Auto-generated catch block
				 logger.error("JSONException Error is getting"+e.getMessage());
			}
	...
	public JSONArray storeRealtorData(String contactId, String email) {
		...
		try {
			...
			String ur = "https://api.wistia.com/v1/stats/events.json?api_password=6bca8b64faaf09189e8266ed51b726292fd133063ffc1ca0d9fab9fc3661f3ab&start_date="
					...
					+ "&end_date="
					+ date.format(cal.getTime()) + "media_id=5x5hnmijeu" +
							"";
			...
			conn.disconnect();
			 ...
			 logger.error("Error occured in storedRelateddata in couchbase"+e.getMessage());
	...
	public JSONArray getVisitorCount() {
		...
		try {
			...
			// String
			// ur="https://api.wistia.com/v1/stats/events.json?api_password=6bca8b64faaf09189e8266ed51b726292fd133063ffc1ca0d9fab9fc3661f3ab";
			String ur = "https://api.wistia.com/v1/stats/visitors.json?api_password=6bca8b64faaf09189e8266ed51b726292fd133063ffc1ca0d9fab9fc3661f3ab&media_id=5x5hnmijeu";
