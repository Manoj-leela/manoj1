...
Logger.debug("applicant ID -->"+applicant.getId());
	...
	@Override
	public void deleteApplicantIncome(Opportunity opportunity)
			throws PostGressDaoServiceException {
		...
		Logger.debug("Assets information data updated into crm_asset Successfully.");
			...
			throw new PostGressDaoServiceException("Error deleting incomeof  applicants in  DB for given opportunityId="+opportunity.getId(),e);
		}
