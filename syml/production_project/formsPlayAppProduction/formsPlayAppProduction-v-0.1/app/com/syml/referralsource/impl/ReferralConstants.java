...
public class ReferralConstants {
	...
	public static final int REFERAL_INVOLVED_STAGE_ID=37;  //dev=6 //prod=37
	...
	public static final String ONTHRAPORT_API_APPID="onthraPortApiAppid";
	public static final String ONTHRAPORT_API_KEY="onthraPortApiKey";
	public static final String TASK_CREATION_APP_URL="https://task.visdom.ca/referaldata";
