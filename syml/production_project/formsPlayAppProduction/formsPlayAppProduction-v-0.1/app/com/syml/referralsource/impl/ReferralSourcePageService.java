...
public class ReferralSourcePageService {
	final String ONTHRAPORT_URL="https://api.ontraport.com/1/objects/saveorupdate";
	/**
	...
	public String sendMailofReferralAgrement(Referral_Source referral_Source)
		...
		if (referral_Source.getIsTouchScreeDevice().equals("yes")) {
			...
			new SendWithUsExample().sendTOReferralAttachment(
					referral_Source.getFirstName(),
					ReferralConstants.SUBMIT_REFERRAL_LINK
							+ referral_Source.getId(),
	...
	public void createContactInOntharaPort(
		...
		try {
			...
			Properties prop=ReadConfigFile.readConfigfile();
			String apiAppid=prop.getProperty(ReferralConstants.ONTHRAPORT_API_APPID);
			String apikey=prop.getProperty(ReferralConstants.ONTHRAPORT_API_KEY);
			...
			URL url = new URL(ONTHRAPORT_URL
					);
			...
			conn.setRequestProperty("Api-Appid", apiAppid);
