...
import com.syml.todoist.CreditInformationTasks;
import com.syml.todoist.DocumentAnalyzerTasks;
import com.syml.todoist.LeadTasks;
import com.syml.todoist.ReferralTasks;
import com.syml.todoist.StageMailTasksCreation;
    ...
    public static Result creatingTasks() {
		...
		if (json == null) {
			...
			try {
				...
				com.syml.dto.ApplicantDocument docList=mapper.readValue(jsonOfDocumentlist.toString(),com.syml.dto.ApplicantDocument.class);
