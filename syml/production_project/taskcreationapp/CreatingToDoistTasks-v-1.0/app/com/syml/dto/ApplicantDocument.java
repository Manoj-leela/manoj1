...
public class ApplicantDocument {
	...
	public String toString() {
		return "ApplicantDocument [firstName=" + firstName + ", lastName="
				+ lastName + ", emailAddress=" + emailAddress + ", documents="
				+ documents + ", applicantCreditDocuments="
				+ applicantCreditDocuments + ", co_applicantCreditDocuments="
				+ co_applicantCreditDocuments + ", co_firstName="
				+ co_firstName + ", co_lastName=" + co_lastName
				+ ", co_emailAddress=" + co_emailAddress + ", co_documents="
				+ co_documents + ", propertyDocments=" + propertyDocments
				+ ", downPayments=" + downPayments + ", opprtunityId="
				+ opprtunityId + ", lendingGoal=" + lendingGoal + "]";
	}
