...
public class ExpirtyDatePageCR extends CssLayout implements View  {
	...
	public void settopbarLayout(){
		...
		Label label1 = new Label("<span style='color:#0070C0;font-size: 60px;'>P</span>"+"<font size='7'>urchase</font>"+" "+"<span style='color:#0070C0;font-size: 60px;'>P</span>"+"<font size='7'>roposal</font>",ContentMode.HTML);
