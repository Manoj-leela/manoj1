...
public class ExpiryDataTest {
	...
	@Ignore
	@Test
	public void testDateDifferenceLessThanExpiryDate() throws CouchbaseDaoServiceException{
	...
	@Test
	public void testDateDifferenceGreaterThanExpiryDate() throws CouchbaseDaoServiceException{
		ExpiryDate date = new ExpiryDate();
		Date currentdate =date.getCurrentDate();
		Date expirydate =date.getExpiryDate("4406");
