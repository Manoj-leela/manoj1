...
public String toString() {
	return "OrignalDetails [propertyValue=" + propertyValue + ", downpaymentEquity=" + downpaymentEquity
			+ ", mortgageAmount=" + mortgageAmount + ", insuranceAmount=" + insuranceAmount + ", totalMortgage="
			+ totalMortgage + ", amortization=" + amortization + ", mortgageType=" + mortgageType + ", mortgageTerm="
			+ mortgageTerm + ", paymentAmount=" + paymentAmount + ", interestRate=" + interestRate + ", lender="
			+ lender + ", productID=" + productID + "]";
}
