...
import com.syml.proposalRefinance.vaadin.OriginalDetailForm;
import com.syml.proposalRefinance.vaadin.RecommendationDetailForSingleForm;
import com.syml.proposalRefinance.vaadin.RecommendationDetailForm;
...
public class BrokerService {
	...
	public void deletebyidRecommendation(String id, UwAppAllAlgo algo) throws JSONException, ProposalException {
	...
	public void deletebyidCombineRecommendation(String id, UwAppAllAlgo algo)
		...
		try {
			...
			throw new ProposalException("Combined Recommendation getting null", e);
		}
	...
	public void updateCombineRecommendationOnClickUpdate(Grid table, UwAppAllAlgo algo) {
		table.getColumn("update").setRenderer(new ButtonRenderer(event -> {
		}));
		table.getEditorFieldGroup().addCommitHandler(new CommitHandler() {
			@Override
			...
			public void postCommit(CommitEvent commitEvent) throws CommitException {
				...
				try {
					updateCombinedRecommendation(rec, algo);
				} catch (JSONException | ProposalException e) {
					logger.error("error in update CombinedRecommendation " + e.getMessage());
					// throw new ProposalException("error in update
