...
public class UwAppAllAlgo {
	...
	private Set<CombinedTable> combinedTable;
	private Set<FailureReason> failureReason;
	private Set<Brokernotes> brokernotes;
	private Set<ApplicantSummary> applicantSummary;
	...
	public Set<CombinedTable> getCombinedTable() {
		return combinedTable;
	}
	public void setCombinedTable(Set<CombinedTable> combinedTable) {
		this.combinedTable = combinedTable;
	}
	public Set<FailureReason> getFailureReason() {
		return failureReason;
	}
	public void setFailureReason(Set<FailureReason> failureReason) {
		this.failureReason = failureReason;
	}
	public Set<Brokernotes> getBrokernotes() {
		return brokernotes;
	}
	public void setBrokernotes(Set<Brokernotes> brokernotes) {
		this.brokernotes = brokernotes;
	}
	public Set<ApplicantSummary> getApplicantSummary() {
		return applicantSummary;
	}
	public void setApplicantSummary(Set<ApplicantSummary> applicantSummary) {
	...
	public void setCombinedRecommendation(Set<CombinedRecommendation> combinedRecommendation) {
