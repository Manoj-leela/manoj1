...
import com.syml.proposalRefinance.couchbase.*;
...
public class ExpiryDate {
	...
	public static void setExpiryDate(Date date, String oppertunityId) throws CouchbaseDaoServiceException {
		logger.debug("setExpiryDate");
		
		/*
		 * TODO Change may be required here
		 */
		...
		try {
			...
			cbdata.UpdateDataCouchbase(oppertunityId, expiryDate);
		} catch (CouchbaseDaoServiceException e1) {
