...
public class HttpsConnectionCase {
	private static org.slf4j.Logger logger = LoggerFactory.getLogger(HttpsConnectionCase.class);
	...
	public static void  chnageStageToPostSelction(String oppertunutyId ) throws XmlRpcException,OpeneERPApiException{
		Session session = new Session("openerp.crm.local", 8069, "symlsys", "guy@visdom.ca", "VisdomTesting");
	...
	public static String  getCompanyName(String oppertunutyId) throws  XmlRpcException,OpeneERPApiException{
