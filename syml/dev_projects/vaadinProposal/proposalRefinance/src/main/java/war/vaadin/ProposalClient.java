...
public class ProposalClient extends CssLayout implements View {
	...
	public void setLableforMakeSense() {
		...
		Label sensetext2 = new Label("<li>" + sense[2].replace("-","") + "</li>", ContentMode.HTML);
	...
	public void setLabelforNotes() {
		...
		Label optionlabeltext1 = new Label("&nbsp;" + "<li>" + map[1].replaceFirst("-","") + "</li>", ContentMode.HTML);
	...
	private String getCompanyName(String oppid) {
		...
		String companyName = null;
		  ...
		  ( OpeneERPApiException e) { logger.error("xml Rpc Exception (){} : " +
		 e.getMessage());
