...
public class RecommendationDetailForm  extends GridLayout{
	...
	TextField mortgageAmount1 =new TextField();
	
	TextField amortization = new TextField();
	TextField amortization1 = new TextField();
	
	TextField mortgageType = new TextField();
	TextField mortgageType1 = new TextField();
	
	TextField mortgageTerm = new TextField();
	TextField mortgageTerm1 = new  TextField();
	
	TextField paymentAmount = new TextField();
	TextField paymentAmount1 = new TextField();
	
	TextField interestRate = new TextField();
	TextField interestRate1 = new TextField();
	
	
	TextField lender = new TextField();
	TextField totalPayment = new TextField();
	TextField totalMortgageAmount = new TextField();
	
	TextField initealhere =new TextField();
